...
if my_name == 'Skillcrush'
	...
	puts "Oops, I thought your name was
Skillcrush. Sorry about that, #{my_name}"
end
...
if (fav_color == 'red')
	...
	puts "Hmm, #{fav_color} well I don't know what that color is!
It must be nice if you like it #{my_name}."
end